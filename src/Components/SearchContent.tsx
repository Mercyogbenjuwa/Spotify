        ...
        {searchResults.map((result) => (
          <div className="col-2" key={result.track.key}>
            <div className="card" id="darker">
              <img
                src={
                  result.track.images.coverarthq ||
              ...
              <div className="card-body">
                <h5 className="card-title">
                  {result.track.title.length > 20
                    ? result.track.title.substring(0, 20) + "..."
                    : result.track.title}
                </h5>
                <p className="card-text">
                  {result.track.subtitle.length > 30
                    ? result.track.subtitle.substring(0, 30) + "..."
